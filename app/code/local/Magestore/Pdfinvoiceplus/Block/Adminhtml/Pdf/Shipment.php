 ...
 */
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Pdf_Shipment extends Mage_Adminhtml_Block_Sales_Items_Abstract {

    public function __construct() {
        parent::__construct();
        $this->addItemRender('default','adminhtml/sales_items_renderer_default','pdfinvoiceplus/sales/order/shipment/items/renderer/default.phtml');
        $this->addItemRender('bundle','bundle/adminhtml_sales_order_items_renderer','pdfinvoiceplus/sales/bundle/shipment/items/renderer/renderer.phtml');
