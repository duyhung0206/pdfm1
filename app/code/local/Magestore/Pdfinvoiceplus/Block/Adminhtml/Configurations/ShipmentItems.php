 ...
 */
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_ShipmentItems extends Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_Checkbox
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray() {
        ...
        $all_var = $var_model->getAllVars_Shipment_Items();
        $onHiden_Var = $var_model->getVarsOnHiden_Shipment_Items();
        $mathVar = array();
