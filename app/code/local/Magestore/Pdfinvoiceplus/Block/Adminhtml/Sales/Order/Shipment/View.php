 ...
 */
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Sales_Order_Shipment_View extends Mage_Adminhtml_Block_Sales_Order_Shipment_View
{
    /*
    ...
    {
        return $this->getUrl('pdfinvoiceplusadmin/adminhtml_shipment/print', array(
                    'shipment_id' => $this->getShipment()->getId()
                ));
    }
    
    private function getCurrentShipmentOrderStore()
    {
        if ($storeId = $this->getShipment()->getOrder()->getStore()->getId())
        {
