...
class Magestore_Pdfinvoiceplus_Model_Sales_Order_Shipment extends Mage_Sales_Model_Order_Shipment
{
    /**
    ...
    public function sendEmail($notifyCustomer = true, $comment = '')
    {
        ...
        if($isAttach){
            if(Mage::helper('pdfinvoiceplus/pdf')->customPdfEnable()){
                ...
                $pdfFile = Mage::getSingleton('pdfinvoiceplus/entity_shipmentpdf')->getThePdf((int) $this->getId(), false);
