...
class Magestore_Pdfinvoiceplus_Model_Entity_Shipmentgenerator extends Magestore_Pdfinvoiceplus_Model_Entity_Abstractextend {
    ...
    public function setTheSourceId($shipmentId)
    {
        $this->_sourceId = $shipmentId;
    ...
    {
        if ($storeId = $this->getTheShipment()->getOrder()->getStore()->getId())
        {
...
//        }
    ...
    public function getFileName() {
                if ($fileName = $this->createTemplate()->getData('shipment_filename'))
        {
     ...
     public function getBody()
    {
        ...
        if ($body = $this->createTemplate()->getData('shipment_html'))
        {
            return $body;
    ...
    public function getTheTemplateBodyWithItems()
    {
        ...
        $items = Mage::getModel('pdfinvoiceplus/entity_itemsshipment')
                        ->setSource($this->getTheShipment())->setOrder($this->getTheShipment()->getOrder());
    ...
    public function mainVariableProcess()
    {
        ...
        //auto insert totals
        $total_shipment = Mage::getModel('pdfinvoiceplus/entity_totalsRender_shipment');
        $total_shipment->setSource($this->getTheShipment())
            ->setHtml($templateText)->setTemplateId($this->createTemplate()->getId());
        $templateText = $total_shipment->renderHtml();
