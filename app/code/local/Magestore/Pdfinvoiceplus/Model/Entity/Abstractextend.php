...
abstract class Magestore_Pdfinvoiceplus_Model_Entity_Abstractextend extends Mage_Core_Model_Abstract {
   ...
   protected $_order;
     ...
     * @return Magestoer_Pdfinvoiceplus_Model_Entity_Abstract
     */
    ...
    public function getSource()
    {
        ...
        {
            Mage::throwException(Mage::helper('pdfinvoiceplus')->__('Source object is not specified.'));
        }
        return $this->_source;
    }
    ...
    public function getOrder()
    {
        ...
        {
            Mage::throwException(Mage::helper('pdfinvoiceplus')->__('Order object is not specified.'));
        }
        return $this->_order;
    }
    ...
    public function getItem()
    {
        ...
        {
            Mage::throwException(Mage::helper('pdfinvoiceplus')->__('Item object is not specified.'));
        }
        return $this->_item;
    }
    ...
    public function getVars()
    {
        ...
        {
            Mage::throwException(Mage::helper('pdfinvoiceplus')->__('Vars not found.'));
        }
        return $this->_vars;
    }
    ...
    protected function prepareHtml(){
        Mage::helper('pdfinvoiceplus/pdf')->setTemplate($this->templateId);
    ...
    public function toHtml(){
        $this->prepareHtml();
        return $this->getTheProcessedTemplate();
    }
}
